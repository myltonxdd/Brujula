...
<body>
    <form method="post" style="font-family: 'Inter', sans-serif;"
        ...
        <div
            class=" bg-gradient-to-b from-[#FF0000] via-[#ff0000] to-transparent flex flex-col justify-center items-center text-white h-[12%] w-full pb-8">
        ...
        <div class="  flex flex-col text-white justify-start items-center h-[80%] w-full">
            ...
            <div class=" flex flex-col w-[80%]">
                ...
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MFiQ1" name="MFiQ1" type="text"
            ...
            <div class=" flex flex-col w-[80%]">
                ...
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MFiQ2" name="MFiQ2" type="text"
                    placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                ...
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MFiQ3" name="MFiQ3" type="text"
                    placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                ...
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MFiQ4" name="MFiQ4" type="text"
                    placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                ...
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MFiQ5" name="MFiQ5" type="text"
                    placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                ...
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MFiQ6" name="MFiQ6" type="text"
                    placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                ...
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MFiQ7" name="MFiQ7" type="text"
                    placeholder="Ingrese aquí">
            </div>
        </div>
