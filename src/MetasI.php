...
<body>
    <form method="post" style="font-family: 'Inter', sans-serif;" class=" bg-gradient-to-b from-[#3068D8] to-[#000714] w-screen h-[180vh] ">
        <div class=" bg-gradient-to-b from-[#00b050] via-[#00b050] to-transparent flex flex-col justify-center items-center text-white h-[12%] w-full pb-8">
        ...
        <div class="  flex flex-col text-white justify-start items-center h-[80%] w-full">
            ...
            <div class="mt-3 border rounded-2xl flex justify-around items-center w-[80%] h-16">
                ...
                <label class="flex flex-col rounded-l-2xl justify-center items-center w-[50%] " for="eduFormal">
                    EDUCACIÓN FORMAL</label>
                <!-- input radio 02 'auto educación' -->
                <input type="radio" id="autoEducacion" name="metasI" value="autoEducacion" />
                <!-- Tamaño del weight es 50% ya que son 2 botones -->
                <label class="flex flex-col rounded-r-2xl justify-center items-center w-[50%]" for="autoEducacion">
                    <p>AUTO EDUCACIÓN</p>
                </label>
            </div>
            ...
            <div class=" flex flex-col w-[80%]">
                ...
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MIQ1" name="MIQ1" type="text" placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Por qué lo hago?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MIQ2" name="MIQ2" type="text" placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Cómo lo haré?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MIQ3" name="MIQ3" type="text" placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Cuándo lo haré?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MIQ4" name="MIQ4" type="text" placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Dónde lo haré?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MIQ5" name="MIQ5" type="text" placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Con quien lo haré?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MIQ6" name="MIQ6" type="text" placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Cuánto me costará?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MIQ7" name="MIQ7" type="text" placeholder="Ingrese aquí">
            </div>
        </div>
