...
<body>
    <form style="font-family: 'Inter', sans-serif;" class=" bg-gradient-to-b from-[#3068D8] to-[#000714] w-screen h-[180vh] ">
        <div class=" shadow-black bg-gradient-to-b from-[#ffc000] via-[#ffc000] to-transparent flex flex-col justify-center items-center text-white h-[12%] w-full pb-8">
            <p class=" text-lg font-semibold">METAS</p>
            <p class=" text-lg font-semibold">FAMILIARES</p>
        </div>
        <div class="  flex flex-col text-white justify-start items-center h-[80%] w-full">
            ...
            <div class="mt-3 border rounded-2xl flex justify-around items-center w-[80%] h-16">
                ...
                <!-- input radio 03 'Hijo' -->
                <input type="radio" id="hijo" name="metasF" value="hijo" />
                <!-- Tamaño del weight es 33.33% ya que son 3 botones -->
                <label class="flex flex-col rounded-r-2xl justify-center items-center w-[33.33%]" for="hijo">
                    <p>HIJO</p>
                </label>
            </div>
            ...
            <div class=" flex flex-col w-[80%]">
                ...
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MFaQ1" name="MFaQ1" type="text" placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Por qué lo hago?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MFaQ2" name="MFaQ2" type="text" placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Cómo lo haré?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MFaQ3" name="MFaQ3" type="text" placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Cuándo lo haré?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MFaQ4" name="MFaQ4" type="text" placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Dónde lo haré?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MFaQ5" name="MFaQ5" type="text" placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Con quien lo haré?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MFaQ6" name="MFaQ6" type="text" placeholder="Ingrese aquí">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Cuánto me costará?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MFQ7" name="MFQ7" type="text" placeholder="Ingrese aquí">
            </div>
        </div>
