    ...
    <form method="post" style="font-family: 'Inter', sans-serif;" class=" bg-gradient-to-b from-[#3068D8] to-[#000714] w-screen h-[180vh] ">
        ...
        <div class="  flex flex-col text-white justify-start items-center h-[80%] w-full">
            ...
            <div class=" flex flex-col w-[80%]">
                ...
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MEQ1" name="MEQ1" type="text" placeholder="Ingrese aqui">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Por qué lo hago?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MEQ2" name="MEQ2" type="text" placeholder="Ingrese aqui">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Cómo lo haré?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MEQ3" name="MEQ3" type="text" placeholder="Ingrese aqui">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Cuándo lo haré?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MEQ4" name="MEQ4" type="text" placeholder="Ingrese aqui">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Dónde lo haré?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MEQ5" name="MEQ5" type="text" placeholder="Ingrese aqui">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Con quien lo haré?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MEQ6" name="MEQ6" type="text" placeholder="Ingrese aqui">
            </div>
            <div class=" flex flex-col w-[80%]">
                <li class="mt-3 px-3 text-xl">
                    ¿Cuánto me costará?
                </li>
                <input class="mt-3 rounded-full py-4 px-6 text-black" id="MEQ7" name="MEQ7" type="text" placeholder="Ingrese aqui">
            </div>
        </div>
